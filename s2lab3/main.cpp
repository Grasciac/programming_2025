...
int main()
{
    ...
    countries.push_back(Country(
        "Германия", "Берлин", 3, 10, 1990, 357022, 83000000,
        {"Берлин", "Гамбург", "Мюнхен"}));
    countries.push_back(Country(
        "Франция", "Париж", 22, 9, 1792, 551695, 67000000,
        {"Париж", "Марсель", "Лион"}));
    countries.push_back(Country(
        "Япония", "Токио", 11, 2, -660, 377975, 125000000,
        {"Токио", "Осака", "Киото"}));
    ...
    do
    {
        ...
        else if (choice == 2)
        {
            ...
            countries.push_back(Country(
                name, capital, day, month, year, square, population, cities));
        }
        else if (choice == 3)
        {
            int a, b;
